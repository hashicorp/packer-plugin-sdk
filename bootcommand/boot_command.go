...
var g = &grammar{
	rules: []*rule{
		...
		},
		{
			...
			expr: &choiceExpr{
				...
				alternatives: []interface{}{
					...
					&litMatcher{
						pos:        position{line: 69, col: 87, offset: 1585},
						val:        "leftshift",
						ignoreCase: true,
						want:       "\"leftShift\"i",
					},
					...
					&litMatcher{
						pos:        position{line: 70, col: 25, offset: 1622},
						val:        "rightctrl",
						ignoreCase: true,
						want:       "\"rightCtrl\"i",
					},
					&litMatcher{
						pos:        position{line: 70, col: 40, offset: 1637},
						val:        "rightmeta",
						ignoreCase: true,
						want:       "\"rightMeta\"i",
					},
					&litMatcher{
						pos:        position{line: 70, col: 55, offset: 1652},
						val:        "rightshift",
						ignoreCase: true,
						want:       "\"rightShift\"i",
					},
					&litMatcher{
						pos:        position{line: 70, col: 71, offset: 1668},
						val:        "leftsuper",
						ignoreCase: true,
						want:       "\"leftSuper\"i",
					},
					&litMatcher{
						pos:        position{line: 70, col: 86, offset: 1683},
						val:        "rightsuper",
						ignoreCase: true,
						want:       "\"rightSuper\"i",
					},
					&litMatcher{
						pos:        position{line: 71, col: 11, offset: 1707},
						val:        "left",
						ignoreCase: true,
						want:       "\"left\"i",
					},
					&litMatcher{
						pos:        position{line: 71, col: 21, offset: 1717},
						val:        "right",
						ignoreCase: true,
						want:       "\"right\"i",
					},
					&litMatcher{
						pos:        position{line: 71, col: 32, offset: 1728},
						val:        "menu",
						ignoreCase: true,
						want:       "\"menu\"i",
					},
		...
		{
			name: "NonZeroDigit",
			pos:  position{line: 73, col: 1, offset: 1737},
			expr: &charClassMatcher{
				pos:        position{line: 73, col: 16, offset: 1752},
				val:        "[1-9]",
				ranges:     []rune{'1', '9'},
				ignoreCase: false,
				inverted:   false,
		...
		{
			name: "Digit",
			pos:  position{line: 74, col: 1, offset: 1758},
			expr: &charClassMatcher{
				pos:        position{line: 74, col: 9, offset: 1766},
				val:        "[0-9]",
				ranges:     []rune{'0', '9'},
				ignoreCase: false,
				inverted:   false,
		...
		},
		{
			...
			expr: &choiceExpr{
				pos: position{line: 75, col: 13, offset: 1784},
				alternatives: []interface{}{
					&litMatcher{
						pos:        position{line: 75, col: 13, offset: 1784},
						val:        "ns",
					...
					&litMatcher{
						pos:        position{line: 75, col: 20, offset: 1791},
						val:        "us",
						ignoreCase: false,
						want:       "\"us\"",
					},
					&litMatcher{
						pos:        position{line: 75, col: 27, offset: 1798},
						val:        "µs",
						ignoreCase: false,
						want:       "\"µs\"",
					},
					&litMatcher{
						pos:        position{line: 75, col: 34, offset: 1806},
						val:        "ms",
						ignoreCase: false,
						want:       "\"ms\"",
					},
					&litMatcher{
						pos:        position{line: 75, col: 41, offset: 1813},
						val:        "s",
						ignoreCase: false,
						want:       "\"s\"",
					},
					&litMatcher{
						pos:        position{line: 75, col: 47, offset: 1819},
						val:        "m",
						ignoreCase: false,
						want:       "\"m\"",
					},
					&litMatcher{
						pos:        position{line: 75, col: 53, offset: 1825},
						val:        "h",
						ignoreCase: false,
						want:       "\"h\"",
					},
		...
		},
		{
			...
			pos:         position{line: 77, col: 1, offset: 1831},
			expr: &zeroOrMoreExpr{
				pos: position{line: 77, col: 19, offset: 1849},
				expr: &charClassMatcher{
					pos:        position{line: 77, col: 19, offset: 1849},
					val:        "[ \\n\\t\\r]",
					chars:      []rune{' ', '\n', '\t', '\r'},
		...
		{
			name: "EOF",
			pos:  position{line: 79, col: 1, offset: 1861},
			expr: &notExpr{
				pos: position{line: 79, col: 8, offset: 1868},
				expr: &anyMatcher{
					line: 79, col: 9, offset: 1869,
				},
			},
		},
	},
