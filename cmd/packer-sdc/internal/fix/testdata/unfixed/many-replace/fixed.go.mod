...
replace github.com/zclconf/go-cty => github.com/nywilken/go-cty v1.12.1 // add by packer-sdc fix as noted in github.com/hashicorp/packer-plugin-sdk/issues/187
